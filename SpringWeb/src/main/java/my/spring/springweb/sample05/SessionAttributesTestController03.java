...
@Controller
@SessionAttributes(value = {"data1", "HONG", "newUser"})
@RequestMapping(value = "sessionAttributesTest03")
public class SessionAttributesTestController03 {
	...
	public String createString1(Model model) {
		log.debug("세션을 직접 얻어올 거에요!");
		
		User user = new User("25", "홍길동", "실용음악");
		model.addAttribute("HONG", user);
	...
	public String myMethod(@ModelAttribute("data1") String str1,
		...
		return "sample05/sessionResult03";
